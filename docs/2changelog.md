...
4. 一键打包支持选择插件和字体库
5. 打包参数模板同步更新至Sprite 1.1.0版本（新增支持极光推送组件、容联云IM组件、BI组件、手势锁屏组件、一键分享组件）
6. 新增后台任务列表显示功能，支持查看当前正在后台执行的部分任务（例如：一键打包）
7. 默认模板中的app.json新增appid和icon字段
8. 更新.component文件和.uixml文件的默认模板
9. 修复导出应用资源功能无法导出组件目录的问题
10. 修复删除require.json中的组件相关配置后，out里对应组件目录不删除的问题
11. 修复Sprite组件管理中的删除组件功能在部分电脑上不生效的问题
12. 修复关于界面中日期格式不正确的问题
13. 修复Mac版关于界面显示和Windows不一致的问题
